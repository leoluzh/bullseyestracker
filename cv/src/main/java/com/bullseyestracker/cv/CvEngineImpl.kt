...
class CvEngineImpl(
    ...
    override fun calibrateBoard(frame: FrameInput): BoardCalibrationResult =
        boardDetector.calibrate(frame)

    override fun detectThrows(frame: FrameInput, calibration: BoardCalibration): List<DetectedThrow> =
